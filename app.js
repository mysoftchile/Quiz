//Importa paquetes y módulos: los que se indican package.json
...
app.set('view engine', 'ejs');  //jade es otro generador de vistas; uso ejs
app.use(partials());
 ...
 app.use(function(req, res, next) {
     if(req.session.user){// si estamos en una sesion
         if(!req.session.marcatiempo)
          {//primera vez se pone la marca de tiempo
